...
require("packer").startup(function(use)
	...
	vim.api.nvim_create_autocmd("LspAttach", {
		...
		callback = function()
			...
			bufmap("n", "<space>ki", "<cmd>lua vim.lsp.buf.hover()<cr>")

			-- Code actions
			bufmap("n", "<C-k><C-a>", "<cmd>lua vim.lsp.buf.code_action()<cr>")
			bufmap("n", "<space>ka", "<cmd>lua vim.lsp.buf.code_action()<cr>")
	...
	null_ls.setup({
		...
		on_attach = function(client, bufnr)
			...
			if client.supports_method("textDocument/formatting") then
				vim.keymap.set("n", "<Leader>kf", handle_format, { buffer = bufnr, desc = "[lsp] format" })
				vim.keymap.set("n", "<C-k><C-f>", handle_format, { buffer = bufnr, desc = "[lsp] format" })
			...
			if client.supports_method("textDocument/rangeFormatting") then
				vim.keymap.set("x", "<Leader>kf", handle_format, { buffer = bufnr, desc = "[lsp] format" })
				vim.keymap.set("x", "<C-k><C-f>", handle_format, { buffer = bufnr, desc = "[lsp] format" })
			end
		end,
	})
